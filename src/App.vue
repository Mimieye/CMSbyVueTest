...
<style lang="sass">
	...
	.editPage
		...
		&::before
			...
			width: 275px
			height: 5px
			background: linear-gradient(90deg, #1A9CCC, #1A9CCC 20%, #F4DA23 20%, #F4DA23 40%, #21933D 40%, #21933D 60%, #D60F68 60%, #D60F68 80%, #093E8E 80%)
		.row
			margin: 25px 0
			display: flex
			&:first-child
